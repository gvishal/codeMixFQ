...
def generateCodemixSentence(input_file, output_file,column_number=0,base='en',mix_lang='hi'):
...
def main():
    ...
    generateCodemixSentence(input_file, output_file, column_number,'en', 'hi')
